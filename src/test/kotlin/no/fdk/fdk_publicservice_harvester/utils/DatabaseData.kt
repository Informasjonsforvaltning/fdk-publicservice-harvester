package no.fdk.fdk_publicservice_harvester.utils
...
val SERVICE_DBO_0 = PublicServiceDBO(
...
val SERVICE_DBO_1 = PublicServiceDBO(
...
val SERVICE_DBO_2 = PublicServiceDBO(
...
private fun PublicServiceDBO.mapDBO(): Document =
    Document()
        .append("_id", uri)
        .append("fdkId", fdkId)
