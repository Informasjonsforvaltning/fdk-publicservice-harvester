...
class ServicesServiceTest {
    ...
    private val service = ServicesService(servicesRepository, miscRepository)
    ...
    internal inner class ServiceById {
        ...
        fun responseIsNullWhenNoModelIsFound() {
            whenever(servicesRepository.findOneByFdkId("123"))
                .thenReturn(null)
        ...
        fun responseIsIsomorphicWithExpectedModel() {
            whenever(servicesRepository.findOneByFdkId(SERVICE_ID_0))
