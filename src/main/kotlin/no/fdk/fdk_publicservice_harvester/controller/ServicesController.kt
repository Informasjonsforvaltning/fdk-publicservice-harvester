package no.fdk.fdk_publicservice_harvester.controller

import no.fdk.fdk_publicservice_harvester.rdf.JenaType
import no.fdk.fdk_publicservice_harvester.rdf.jenaTypeFromAcceptHeader
import no.fdk.fdk_publicservice_harvester.service.PublicServicesService
...
@Controller
@RequestMapping(value = ["/publicservices"], produces = ["text/turtle", "text/n3", "application/rdf+json", "application/ld+json", "application/rdf+xml", "application/n-triples"])
